...
- **HISTÓRIA DO PROCESSO (MASTER)**: Reconstrua a "história" do processo judicial do início ao fim de forma detalhada e didática. Conte como se fosse um livro: causa, marcos principais (citações, penhoras, avaliações, recursos) e estado atual. Identifique termos técnicos complexos e explique-os para leigos.
