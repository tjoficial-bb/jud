  ...
  const handleExtractSectionSmart = async (sectionKey: string) => {
    ...
    try {
      ...
      if (sectionKey === 'imovel') {
        sectionInstruction = `Sua miss√£o priorit√°ria √© extrair TODOS os DADOS DO IM√ìVEL dos documentos fornecidos (tipo_imovel, numero_matricula, cadastro_imobiliario, cartorio_registro, area_terreno, area_privativa, area_util, area_construida, observacoes_imovel). Se houver Inscri√ß√£o Imobili√°ria, Cadastro Municipal ou SQL para busca de IPTU, extraia no campo cadastro_imobiliario. Se houver n√∫meros de √°rea ou descri√ß√£o no edital/matr√≠cula, leia atentamente.`;
      } else if (sectionKey === 'ex_mutuario') {
        sectionInstruction = `Sua miss√£o priorit√°ria √© extrair TODOS os DADOS DO EX-MUTU√ÅRIO / PROPRIET√ÅRIO ANTERIOR / DEVEDORES / EXECUTADOS dos documentos fornecidos. 
Busque atenta e minuciosamente nos anexos (Matr√≠cula, Edital, Processo Judicial) por:
- nome_ex_mutuario (nome completo do devedor/executado)
- cpf_ex_mutuario (CPF ou CNPJ)
- estado_civil_ex_mutuario (solteiro, casado, divorciado, vi√∫vo, etc)
- profissao_ex_mutuario
- conjuge_ex_mutuario (nome e CPF do c√¥njuge/copropriet√°rio)
- endereco_ex_mutuario (endere√ßo completo do devedor)
- observacoes_ex_mutuario (detalhes importantes, falecimento, herdeiros, cita√ß√µes).
N√ÉO DEIXE EM BRANCO se o nome ou CPF do devedor constar em qualquer trecho dos documentos.`;
      } else if (sectionKey === 'ocupacao' || sectionKey === 'ocupacional') {
        sectionInstruction = `Sua miss√£o priorit√°ria √© extrair TODOS os DADOS DE SITUA√á√ÉO OCUPACIONAL E INVESTIGA√á√ÉO DO OCUPANTE (situacao_ocupacional, status_ocupacao, relacao_ex_mutuario, nome_ocupante, cpf_ocupante, telefone_ocupante, tempo_ocupacao, risco_usucapiao, observacoes_ocupacao, folhas_ocupacao). Busque ativamente se h√° auto de constata√ß√£o de ocupa√ß√£o e indique as folhas exatas no campo folhas_ocupacao (ex: fls. 180 e 200).`;
      } else if (sectionKey === 'matricula') {
        sectionInstruction = `Sua miss√£o priorit√°ria √© extrair a AN√ÅLISE DA MATR√çCULA (CRI) (status_matricula, numero_matricula, cadastro_imobiliario, matricula_atualizada, tem_onus, tem_penhora, tem_hipoteca, usufruto_hipoteca, alienacao_fiduciaria, indisponibilidade_bens, indisponibilidade, acao_reipersecutoria, observacoes_matricula, folhas_penhora_matricula). Indique as R. e Av. e folhas nos autos no campo folhas_penhora_matricula (ex: R. 03 / Av. 04 fls. 88).`;
      } else if (sectionKey === 'consolidacao') {
        sectionInstruction = `Sua miss√£o priorit√°ria √© extrair os DADOS DA CONSOLIDA√á√ÉO DE PROPRIEDADE EXTRAJUDICIAL (status_consolidacao, data_consolidacao, intimacao_purga_mora, intimacao_leiloes, averbacao_consolidacao, observacoes_consolidacao, folhas_consolidacao). Indique as folhas e averba√ß√£o no campo folhas_consolidacao (ex: Av. 06 / fls. 310).`;
      } else if (sectionKey === 'nulidade') {
        sectionInstruction = `Sua miss√£o priorit√°ria √© extrair a AN√ÅLISE DE RISCO DE NULIDADE DO LEIL√ÉO (risco_nulidade, risco_geral_nulidade, preco_vil_caracterizado, preco_vil, intimacao_executado, intimacao_conjuge, intimacao_credor_fiduciario, coproprietario_intimado, publicacao_edital_ok, citacao_regular, vicio_citacao, vicio_avaliacao, vicio_publicacao, vicio_procedimental, observacoes_nulidade, folhas_citacao, folhas_intimacao_leilao). Indique as folhas nos autos para cita√ß√£o (folhas_citacao, ex: fls. 50 e 60) e intima√ß√£o do leil√£o (folhas_intimacao_leilao, ex: fls. 120-125).`;
      } else if (sectionKey === 'desocupacao') {
        sectionInstruction = `Sua miss√£o priorit√°ria √© extrair o RISCO E PRAZO DE DESOCUPA√á√ÉO (risco_desocupacao, nivel_risco_desocupacao, estimativa_prazo_desocupacao, prazo_estimado_desocupacao, custo_estimado_desocupacao, liminar_bloqueando, acao_anulatoria, embargos_pendentes, recurso_pendente, observacoes_desocupacao, folhas_ocupacao). Indique as folhas nos autos no campo folhas_ocupacao.`;
      } else if (sectionKey === 'debitos') {
        sectionInstruction = `Sua miss√£o priorit√°ria √© extrair os D√âBITOS DO IM√ìVEL (iptu_atraso, condominio_atraso, outros_debitos, observacoes_debitos, folhas_debitos). Indique as certid√µes e folhas nos autos no campo folhas_debitos (ex: fls. 95 e 98).`;
      } else if (sectionKey === 'edital') {
        sectionInstruction = `Sua miss√£o priorit√°ria √© extrair a AN√ÅLISE DO EDITAL (tipo_leilao, responsabilidade_iptu, responsabilidade_condominio, observacoes_edital, folhas_edital, folhas_avaliacao). Indique as folhas do edital (folhas_edital, ex: fls. 210 e 211) e folhas da avalia√ß√£o (folhas_avaliacao, ex: fls. 150 a 165).`;
      } else if (sectionKey === 'parecer') {
        sectionInstruction = `Sua miss√£o priorit√°ria √© gerar o PARECER FINAL DO INVESTIDOR (risco_geral, recomendacao, justificativa).`;
      }

      const prompt = `Voc√™ √© um especialista em leil√µes de im√≥veis.
${sectionInstruction}

Analise os documentos anexados e retorne um objeto JSON contendo o esquema completo de chaves da An√°lise Smart, preenchendo prioritariamente a se√ß√£o solicitada com m√°xima fidelidade e precis√£o.
Responda APENAS com um objeto JSON v√°lido.`;
      ...
      if ((window as any).customToast) {
        (window as any).customToast("Dados da se√ß√£o atualizados com sucesso!", "success");
      }
    } catch (err: any) {
      console.error(err);
      if ((window as any).customToast) {
  ...
  const handleExtractSectionAssessoria = async (sectionKey: string) => {
    ...
    try {
      ...
      if (sectionKey === 'debitos') {
        sectionInstruction = `Sua miss√£o priorit√°ria √© extrair TODOS os DADOS DO MONTANTE DE D√âBITOS (responsabilidade_debitos, direito_eviccao, ressalvas_eviccao, divida_condominio, divida_iptu, comentarios_debitos).`;
      } else if (sectionKey === 'matricula') {
        sectionInstruction = `Sua miss√£o priorit√°ria √© extrair a AN√ÅLISE DA MATR√çCULA (itens_matricula, comentarios_matricula, data_matricula).`;
      } else if (sectionKey === 'edital') {
        sectionInstruction = `Sua miss√£o priorit√°ria √© extrair a AN√ÅLISE DO EDITAL (tamanho_cidade, entorno_imovel, bairro, e_casa, e_condominio, lance_maximo_sugerido).`;
      } else if (sectionKey === 'viabilidade') {
        sectionInstruction = `Sua miss√£o priorit√°ria √© extrair a AN√ÅLISE DA VIABILIDADE JUR√çDICA DA ARREMATA√á√ÉO (ocupacao, intimacao_registro, forma_intimacao, notificacao_datas, observacoes_purga_mora, leiloes_negativos_averbados, observacoes_leiloes_negativos, comentarios_viabilidade).`;
      } else if (sectionKey === 'acoes') {
        sectionInstruction = `Sua miss√£o priorit√°ria √© extrair as A√á√ïES JUDICIAIS RELEVANTES (acoes_judiciais, risco_juridico, comentarios_adicionais).`;
      } else if (sectionKey === 'conclusao') {
        sectionInstruction = `Sua miss√£o priorit√°ria √© gerar a CONCLUS√ÉO E RECOMENDA√á√ïES FINAIS (comentarios_recomendacoes_finais).`;
      }

      const prompt = `Voc√™ √© um advogado imobili√°rio especialista s√™nior em assessoria e pareceres de leil√µes de im√≥veis.
${sectionInstruction}

Analise os documentos fornecidos e retorne um objeto JSON contendo o esquema completo de chaves da An√°lise de Assessoria, preenchendo prioritariamente a se√ß√£o solicitada com m√°xima fidelidade e precis√£o.
Responda APENAS com um objeto JSON v√°lido.`;
      ...
      if ((window as any).customToast) {
        (window as any).customToast("Dados da se√ß√£o de assessoria atualizados com sucesso!", "success");
      }
    } catch (err: any) {
      console.error(err);
      if ((window as any).customToast) {
...
Sua resposta deve ser APENAS um objeto JSON v√°lido, sem qualquer bloco de c√≥digo markdown ou texto explicativo extra. Siga estritamente este esquema e tipos de dados:
{
  ...
  const triggerAutomaticMatriculaAnalysis = async (docsToUse: any[]) => {
    ...
    try {
      ...
      const userApiKey = resolveApiKey(state.selectedKeySource, state.aiConfig, state.selectedModel || 'gemini-3.7-flash') || "";
      const matriculaPrompt = "Analise a Matr√≠cula detalhadamente, identificando propriet√°rios, aliena√ß√µes, consolida√ß√£o, gravames e √¥nus." + getCustomInstructionsPrompt(state);
...
Gere as 3 grandes se√ß√µes descritas nas instru√ß√µes do sistema para o tipo 'dossier' (Viabilidade, Se√ß√£o Financeira e Se√ß√£o Jur√≠dica) com extrema riqueza de detalhes em Markdown.`;
  ...
  const handleSendTabChat = async (tab: 'edital' | 'matricula' | 'processos' | 'dossier' | 'documents' | 'smart_analysis' | 'assessoria' | 'cnj' | 'investors' | 'instagram' | 'simulations') => {
    ...
    if (tab === 'edital') {
      ...
      setMsgs = setDocumentsChatMessages;
      setSending = setSendingDocumentsChat;
      promptContext = `Dados de Simula√ß√£o Financeira:\n${state.simulationData ? JSON.stringify(state.simulationData, null, 2) : "Sem dados de simula√ß√£o."}`;
    }
    ...
    try {
      ...
      let attachmentsCtx = "";
      if (chatAttachments.length > 0) {
        attachmentsCtx = `\n\nO usu√°rio anexou os seguintes documentos adicionais a este chat da aba ${tab} para consulta/refer√™ncia:\n`;
        chatAttachments.forEach((doc: any, i: number) => {
          attachmentsCtx += `--- IN√çCIO DO ARQUIVO ANEXADO ${i + 1}: ${doc.filename || 'Sem Nome'} ---\n`;
          attachmentsCtx += `Conte√∫do extra√≠do:\n${doc.extracted_text || '(Nenhum conte√∫do de texto p√¥de ser extra√≠do ou o arquivo est√° vazio)'}\n`;
          attachmentsCtx += `--- FIM DO ARQUIVO ANEXADO ${i + 1} ---\n\n`;
      ...
      const response = await sendChatMessage(
        newMessages, 
        `Contexto Relacionado √† Aba ${tab.toUpperCase()}:\n${promptContext}\n${attachmentsCtx}\n\n${SYSTEM_PROMPT}\n\nPor favor, responda o assunto sobre ${tab} considerando com extrema aten√ß√£o e integridade os dados jur√≠dicos e os documentos acima. Responda sempre em portugu√™s do Brasil e de forma direta.`, 
        selectedModel, 
        userApiKey || undefined
      );
      ...
      setMsgs([...newMessages, { role: 'assistant', content: `‚ùå ${errorMessage}` }]);
    } finally {
      setSending(false);
    }
  };
  ...
  const renderTabChat = (tab: 'edital' | 'matricula' | 'processos' | 'dossier' | 'documents' | 'smart_analysis' | 'assessoria' | 'cnj' | 'investors' | 'instagram' | 'simulations') => {
    ...
    if (tab === 'edital') {
      title = "D√∫vidas sobre o Edital";
      placeholder = "Pergunte algo sobre prazos, regras de lance, comiss√£o do leiloeiro...";
      inputVal = editalChatInput;
      setInputVal = setEditalChatInput;
      msgs = editalChatMessages;
      sending = sendingEditalChat;
    } else if (tab === 'matricula') {
      title = "D√∫vidas sobre a Matr√≠cula";
      ...
      title = "Discuss√£o do Processo Judicial";
      ...
      title = "Debate sobre o Dossi√™ Integrado";
      placeholder = "Discuta viabilidade jur√≠dica, aspectos financeiros consolidados ou lances sugeridos...";
      inputVal = dossierChatInput;
      setInputVal = setDossierChatInput;
      msgs = dossierChatMessages;
      sending = sendingDossierChat;
    } else if (tab === 'documents') {
      title = "An√°lise de Documentos e Evid√™ncias";
      placeholder = "Pergunte sobre contradi√ß√µes de datas, falta de certid√µes ou termos ocultos...";
      inputVal = documentsChatInput;
      setInputVal = setDocumentsChatInput;
      msgs = documentsChatMessages;
      sending = sendingDocumentsChat;
    } else if (tab === 'smart_analysis') {
      title = "Debate sobre a An√°lise Smart";
      placeholder = "Discuta os fatores de risco preenchidos, ocupa√ß√£o, desocupa√ß√£o e ex-mutu√°rios...";
      ...
      title = "Parecer da Assessoria Jur√≠dica";
      placeholder = "Debata o parecer estrat√©gico de assessoria, ressalvas de evic√ß√£o ou recomenda√ß√µes...";
      inputVal = assessoriaChatInput;
      setInputVal = setAssessoriaChatInput;
      msgs = assessoriaChatMessages;
      sending = sendingAssessoriaChat;
    } else if (tab === 'cnj') {
      title = "D√∫vidas sobre o Processo CNJ";
      placeholder = "Pergunte sobre custas, r√©us, cita√ß√µes do processo consultado...";
      inputVal = processosChatInput;
      setInputVal = setProcessosChatInput;
      msgs = processosChatMessages;
      sending = sendingProcessosChat;
      ...
      placeholder = "Discuta sobre as proje√ß√µes de taxas, lucros e apresenta√ß√µes...";
      inputVal = documentsChatInput;
      setInputVal = setDocumentsChatInput;
      msgs = documentsChatMessages;
      sending = sendingDocumentsChat;
    } else if (tab === 'instagram') {
      title = "D√∫vidas sobre Capta√ß√£o (Instagram)";
      placeholder = "Discuta o conte√∫do de copy, hashtags, stories e artes geradas...";
      inputVal = documentsChatInput;
      setInputVal = setDocumentsChatInput;
      msgs = documentsChatMessages;
      sending = sendingDocumentsChat;
      ...
      placeholder = "Pergunte sobre viabilidade, TIR, ROI ou composi√ß√£o de despesas...";
      inputVal = documentsChatInput;
      setInputVal = setDocumentsChatInput;
      msgs = documentsChatMessages;
      sending = sendingDocumentsChat;
    ...
    return (
      <div className="space-y-6 pt-10 border-t border-black/5 no-print" id={`chat-section-${tab}`}>
        ...
        <div className="bg-brand-bg rounded-[2rem] p-6 space-y-6 max-h-[350px] overflow-y-auto border border-brand-primary/10">
          {msgs.map((msg, idx) => (
            <div key={idx} className={cnxúÏΩ€rGí6xØß÷®ß
